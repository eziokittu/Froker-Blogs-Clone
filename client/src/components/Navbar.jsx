...
const Navbar = () => {
  ...
  return (
    <div className='flex flex-col max-w-[1500px] sticky top-0 bg-white text-froker-orange text-xl mx-auto justify-center'>
      {/* Main navbar */}
      <div
